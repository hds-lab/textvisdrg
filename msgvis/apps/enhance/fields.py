...
try:
    ...
    add_introspection_rules([], ["^enhance\.fields\.PositiveBigAutoField"])
    add_introspection_rules([], ["^enhance\.fields\.PositiveBigIntegerField"])
    add_introspection_rules([], ["^enhance\.fields\.PositiveBigAutoForeignKey"])
except ImportError:
    pass
